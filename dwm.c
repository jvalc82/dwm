...
__attribute_maybe_unused__ static void quit(const Arg *arg);
...
static void resource_load(XrmDatabase db, char *name, enum resource_type rtype, const void *dst);
...
void
resource_load(XrmDatabase db, char *name, enum resource_type rtype, const void *dst)
{
	char *sdst = NULL;
	int *idst = NULL;
	float *fdst = NULL;
