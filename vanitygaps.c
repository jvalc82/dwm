...
__attribute_maybe_unused__ static void incrigaps(const Arg *arg);
__attribute_maybe_unused__ static void incrogaps(const Arg *arg);
__attribute_maybe_unused__ static void incrohgaps(const Arg *arg);
__attribute_maybe_unused__ static void incrovgaps(const Arg *arg);
__attribute_maybe_unused__ static void incrihgaps(const Arg *arg);
__attribute_maybe_unused__ static void incrivgaps(const Arg *arg);
